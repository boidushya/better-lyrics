...
<p align="center">
 ...
 <img src="https://img.shields.io/badge/version-1.7.2-blue.svg" alt=""/>
...
| **Get data from the clipboard**                                       | [Required to import styles and themes from clipboard](https://github.com/boidushya/better-lyrics/blob/b9d5f888703f1b786e48a4fe66bfec08a1553739/src/options/editor.js#L41)                                      | Only data relevant to themes/styles for Better Lyrics |
| **Input data to the clipboard**                                       | [Required to export styles and themes to clipboard](https://github.com/boidushya/better-lyrics/blob/b9d5f888703f1b786e48a4fe66bfec08a1553739/src/options/editor.js#L62)                                        | Only data relevant to themes/styles for Better Lyrics |
...
| **Access browser tabs**                                               | [Required to ensure code editor works on all tabs (changes applied to Youtube Music tab)](https://github.com/boidushya/better-lyrics/blob/b9d5f888703f1b786e48a4fe66bfec08a1553739/src/options/editor.js#L105) | No data stored                                        |
